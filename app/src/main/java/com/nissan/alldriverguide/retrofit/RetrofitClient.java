...
//    private static final String ROOT_URL = "http://104.236.201.218:84/api/"; // Remote url
    private static final String ROOT_URL = "http://192.168.1.194:8001/api/"; // Remote url
