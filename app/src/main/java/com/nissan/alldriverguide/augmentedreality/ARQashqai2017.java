 ...
 */
public class ARQashqai2017 implements GLSurfaceView.Renderer, SampleAppRendererControl, View.OnClickListener {
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()) {
                    case R.id.btn_ac_manual_full_left:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_2017_ac_manual_left, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_ac_manual_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_ac_manual_full_middle:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_2017_ac_manual_middle, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_ac_manual_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_ac_manual_full_right:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_2017_ac_manual_right, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_ac_manual_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_wo_navi_full_left:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_2017_radio_wo_navi_left, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_radio_wo_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_wo_navi_full_middle:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_2017_radio_wo_navi_middle, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_radio_wo_navi_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_wo_navi_full_right:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_2017_radio_wo_navi_right, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_radio_wo_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_full_left_top:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_2017_radio_navi_left_top, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_radio_navi_left_top.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_full_middle_top:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_2017_radio_navi_middle_top, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_radio_navi_middle_top.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_full_right_top:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_2017_radio_navi_right_top, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_radio_navi_right_top.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_radio_full_left_bottom:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_2017_radio_navi_left_bottom, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_radio_navi_left_bottom.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_full_middle_bottom:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_2017_radio_navi_middle_bottom, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_radio_navi_middle_bottom.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_full_right_bottom:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_2017_radio_navi_right_bottom, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_radio_navi_right_bottom.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_ac_auto_full_left:
                        ...
                        mActivity.inflatedLayout_second = inflater.inflate(
                                R.layout.qashqai_2017_ac_auto_left, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_ac_auto_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_ac_auto_full_middle:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(
                                R.layout.qashqai_2017_ac_auto_middle, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_ac_auto_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_ac_auto_full_right:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(
                                R.layout.qashqai_2017_ac_auto_right, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai_2017_ac_auto_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
...
//                            mActivity.onPause();
                    ...
                    } else if (userDataToCompare.equalsIgnoreCase("Steering_wheel_right_new_1")
                            || userDataToCompare.equalsIgnoreCase("Steering_wheel_right_new_2")
                            || userDataToCompare.equalsIgnoreCase("Steering_wheel_right_new_3")) {
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_steering_wheel_right_new, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_steering_right_new.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        Values.ar_value = Analytics.STEERING_RIGHT;
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_steering_right, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_steering_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_automatic_drive_positioner, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_automatic_drive_positioner.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_tripreset_switch, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_tripreset_switch.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_combimeter_view, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_combimeter_view.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_start_stop_ignition, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_start_stop_ignition.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_multiswitch_new, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_multiswitch_new.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        Values.ar_value = Analytics.MIXED_PANEL;
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_multi_switch, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_multi_switch.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_ac_auto_full, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_ac_auto_full.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_ac_auto_left, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_ac_auto_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_ac_auto_middle, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_ac_auto_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_ac_auto_right, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_ac_auto_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_ac_manual_middle, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_ac_manual_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        Values.ar_value = Analytics.MANUAL_AC;
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_ac_manual_left, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_ac_manual_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        Values.ar_value = Analytics.MANUAL_AC;
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_ac_manual_right, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_ac_manual_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        Values.ar_value = Analytics.MANUAL_AC;
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_ac_manual_full, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_ac_manual_full.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_radio_wo_navi_full, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_radio_wo_navi_full.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_radio_wo_navi_left, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_radio_wo_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        Values.ar_value = Analytics.RADIO_WO_NAVI;
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_radio_wo_navi_right, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_radio_wo_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        Values.ar_value = Analytics.RADIO_WO_NAVI;
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_radio_wo_navi_middle, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_radio_wo_navi_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_radio_navi_full, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_radio_navi_full.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));

                        buttonEventInitial(mActivity.inflatedLayout.findViewById(R.id.btn_radio_full_left_top));
                        buttonEventInitial(mActivity.inflatedLayout.findViewById(R.id.btn_radio_full_middle_top));
                        buttonEventInitial(mActivity.inflatedLayout.findViewById(R.id.btn_radio_full_right_top));
                        buttonEventInitial(mActivity.inflatedLayout.findViewById(R.id.btn_radio_full_left_bottom));
                        buttonEventInitial(mActivity.inflatedLayout.findViewById(R.id.btn_radio_full_middle_bottom));
                        buttonEventInitial(mActivity.inflatedLayout.findViewById(R.id.btn_radio_full_right_bottom));
...
//                            mActivity.onPause();
                        ...
                        Values.ar_value = Analytics.RADIO_W_NAVI;
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_radio_navi_left_top, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_radio_navi_left_top.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        Values.ar_value = Analytics.RADIO_W_NAVI;
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_radio_navi_right_top, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_radio_navi_right_top.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        Values.ar_value = Analytics.RADIO_W_NAVI;
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_radio_navi_middle_top, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_radio_navi_middle_top.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
...
//                            mActivity.onPause();
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_parking_brake, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai_2017_parking_brake.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                            ...
                            || userDataToCompare.equalsIgnoreCase("heated_front_seats_4")) {
...
//                            mActivity.onPause();
                        ...
                        Values.ar_value = Analytics.PARKING_BRAKE;
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai_2017_heated_seat_switches, null, false);
