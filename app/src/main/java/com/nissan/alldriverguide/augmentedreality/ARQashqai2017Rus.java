            ...
            public void onClick(View v) {
                ...
                switch (v.getId()) {
                    ...
                    case R.id.btn_radio_with_navi_left:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai2017rus_radio_w_navi_left, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai2017rus_radio_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_with_navi_right:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai2017rus_radio_w_navi_right, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai2017rus_radio_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_with_navi_middle:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai2017rus_radio_w_navi_middle, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai2017rus_radio_navi_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_without_navi_full_left:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai2017rus_radio_wo_navi_left, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai2017rus_radio_wo_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_without_navi_full_middle:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai2017rus_radio_wo_navi_middle, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai2017rus_radio_wo_navi_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_without_navi_full_right:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai2017rus_radio_wo_navi_right, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai2017rus_radio_wo_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_ac_auto_full_left:
                        ...
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai2017rus_ac_auto_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_ac_auto_full_middle:
                        ...
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai2017rus_ac_auto_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_ac_auto_full_right:
                        ...
                        setBackground(mActivity.inflatedLayout_second, drawables + "qashqai2017rus_ac_auto_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
            ...
            handler.post(new Runnable() {
                public void run() {
                    ...
                    if (userDataToCompare.equalsIgnoreCase("steering_wheel_left_5")
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_steering_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_steering_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_sos.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_tripreset_switch.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_ac_auto_full.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai2017rus_ac_auto_left, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_ac_auto_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai2017rus_ac_auto_middle, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_ac_auto_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai2017rus_ac_auto_right, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_ac_auto_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_radio_wo_navi_full.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_radio_wo_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_radio_wo_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_radio_wo_navi_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_radio_navi_full.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_radio_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_radio_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.qashqai2017rus_radio_w_navi_right, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_radio_navi_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_parking_brake.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "qashqai2017rus_all_mode.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
