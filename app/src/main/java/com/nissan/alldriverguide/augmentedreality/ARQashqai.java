 ...
 */
public class ARQashqai implements GLSurfaceView.Renderer, SampleAppRendererControl, View.OnClickListener {
    ...
    public ARQashqai(ImageTargetActivity activity, SampleApplicationSession session) {
        mActivity = activity;
        ...
        img_view.setOnClickListener(v -> {
            ...
            switch (v.getId()) {
                case R.id.btn_radio_without_navi_full_left:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "qashqai_eur_radio_wo_navi_left.png");
                ...
                case R.id.btn_radio_without_navi_full_middle:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "qashqai_eur_radio_wo_navi_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;

                case R.id.btn_radio_without_navi_full_right:
                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_radio_wo_navi_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "qashqai_eur_radio_wo_navi_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_with_navi_left:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "qashqai_eur_radio_navi_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;

                case R.id.btn_radio_with_navi_middle:
                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_radio_navi_middle, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "qashqai_eur_radio_navi_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_with_navi_right:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "qashqai_eur_radio_navi_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;

                case R.id.btn_ac_full_left:
                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_ac_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "qashqai_eur_ac_auto_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;

                case R.id.btn_ac_full_middle:
                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_ac_middle, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "qashqai_eur_ac_auto_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;

                case R.id.btn_ac_full_right:
                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.qashqai_ac_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "qashqai_eur_ac_auto_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;

                case R.id.txt_view_ac_man_left:
                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(
                            R.layout.qashqai_ac_man_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "qashqai_eur_ac_manual_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;

                case R.id.txt_view_ac_man_middle:
                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(
                            R.layout.qashqai_ac_man_middle, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "qashqai_eur_ac_manual_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;

                case R.id.txt_view_ac_man_right:
                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(
                            R.layout.qashqai_ac_man_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "qashqai_eur_ac_manual_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
            ...
            handler.post(() -> {
                ...
                if (userDataToCompare.equalsIgnoreCase("steering_left_1")
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_steering_view_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_steering_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_steering_view_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_steering_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_tripreset_switch, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_tripreset_switch.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_combimeter.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_start_stop_ignition, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_start_stop_ignition.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_mixedpanel, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_multi_switch.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_ac, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_ac_auto_main.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.AUTO_AC;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_ac_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_ac_auto_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.AUTO_AC;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_ac_middle, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_ac_auto_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.AUTO_AC;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_ac_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_ac_auto_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_ac_man_middle, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_ac_manual_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_ac_man_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_ac_manual_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_ac_man_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_ac_manual_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.MANUAL_AC;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_ac_manual_main, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_ac_manual_main.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));

                    buttonEventInitial(ImageTargetActivity.inflatedLayout.findViewById(R.id.txt_view_ac_man_left));
                    buttonEventInitial(ImageTargetActivity.inflatedLayout.findViewById(R.id.txt_view_ac_man_middle));
                    buttonEventInitial(ImageTargetActivity.inflatedLayout.findViewById(R.id.txt_view_ac_man_right));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_eur_all_mode, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_all_mode.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_radio_without_navi_main, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_radio_wo_navi_main.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_radio_wo_navi_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_radio_wo_navi_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.RADIO_WO_NAVI;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_radio_wo_navi_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_radio_wo_navi_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.RADIO_WO_NAVI;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_radio_wo_navi_middle, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_radio_wo_navi_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_radio_with_navi, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_radio_navi_main.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.RADIO_W_NAVI;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_radio_w_navi_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_radio_navi_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.RADIO_W_NAVI;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_radio_w_navi_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_radio_navi_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.qashqai_parking_brake, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "qashqai_eur_parking_brake.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
