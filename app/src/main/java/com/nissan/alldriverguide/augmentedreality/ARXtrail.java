            ...
            public void onClick(View v) {
                ...
                switch (v.getId()) {
                    case R.id.btn_ac_full_left:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.xtrail_ac_left, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_eur_ac_auto_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_ac_full_middle:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.xtrail_ac_middle, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_eur_ac_auto_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_ac_full_right:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.xtrail_ac_right, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_eur_ac_auto_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_with_navi_left:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.xtrail_radio_w_navi_left, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_eur_radio_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_radio_with_navi_middle:
                        ...
                        setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_eur_radio_navi_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_with_navi_right:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.xtrail_radio_w_navi_right, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_eur_radio_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_without_navi_full_left:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.xtrail_radio_wo_navi_left, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_eur_radio_wo_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_without_navi_full_middle:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.xtrail_radio_wo_navi_middle, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_eur_radio_wo_navi_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;

                    case R.id.btn_radio_without_navi_full_right:
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.xtrail_radio_wo_navi_right, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_eur_radio_wo_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
            ...
            handler.post(new Runnable() {
                public void run() {
                    ...
                    if (userDataToCompare.equalsIgnoreCase("steering_left_1")
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_steering_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_steering_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_radio_wo_navi_main.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_tripreset_switch.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_combimeter.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_parking_brake.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_start_stop_ignition.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_multi_switch.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_ac_auto_main.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_ac_auto_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_ac_auto_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_ac_auto_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_ac_manual_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_ac_manual_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_ac_manual_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_ac_manual_main.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_radio_navi_main.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_radio_wo_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_radio_wo_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_radio_wo_navi_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_radio_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_eur_radio_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_all_mode.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
