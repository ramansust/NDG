...
public class ARXtrail2020Eur extends ARCommon {


    public ARXtrail2020Eur(ImageTargetActivity activity, SampleApplicationSession session) {
        ...
        img_view.setOnClickListener(v -> {
            ...
            switch (v.getId()) {
                case R.id.btn_ac_manual_full_left:
                    ...
                    setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_2020_ac_manual_left.png");
                ...
                case R.id.btn_ac_manual_full_middle:
                    ...
                    setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_2020_ac_manual_middle.png");
                    mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_ac_manual_full_right:
                    ...
                    setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_2020_ac_manual_right.png");
                    mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_wo_navi_full_left:
                    ...
                    setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_2020_radio_wo_navi_left.png");
                    mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_wo_navi_full_middle:
                    ...
                    setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_2020_radio_wo_navi_middle.png");
                    mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_wo_navi_full_right:
                    ...
                    setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_2020_radio_wo_navi_right.png");
                    mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_full_left:
                    ...
                    setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_2020_radio_navi_left.png");
                    mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_full_middle:
                    ...
                    setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_2020_radio_navi_middle.png");
                    mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_full_right:
                    ...
                    setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_2020_radio_navi_right.png");
                    mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_ac_auto_full_left:
                    ...
                    setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_2020_ac_auto_left.png");
                    mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_ac_auto_full_middle:
                    ...
                    setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_2020_ac_auto_middle.png");
                    mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_ac_auto_full_right:
                    ...
                    setBackground(mActivity.inflatedLayout_second, drawables + "xtrail_2020_ac_auto_right.png");
                    mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                    break;
            ...
            handler.post(new Runnable() {
                public void run() {
                    ...
                    if (userDataToCompare.equalsIgnoreCase("steering_left_1")
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_steering_left.png");
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_steering_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_tripreset_switch.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_combimeter_view.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_start_stop_ignition.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_multi_switch.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_ac_auto_full.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.xtrail_2017_ac_auto_left, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_ac_auto_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.xtrail_2017_ac_auto_middle, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_ac_auto_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        mActivity.inflatedLayout = inflater.inflate(
                                R.layout.xtrail_2017_ac_auto_right, null, false);
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_ac_auto_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_ac_manual_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_ac_manual_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_ac_manual_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_ac_manual_full.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_radio_wo_navi_full.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_radio_wo_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_radio_wo_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_radio_wo_navi_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_radio_navi_full.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_radio_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_radio_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_radio_navi_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_parking_brake.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "xtrail_2020_all_mode.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
