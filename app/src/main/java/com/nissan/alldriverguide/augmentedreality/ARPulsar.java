 ...
 */
public class ARPulsar implements GLSurfaceView.Renderer, SampleAppRendererControl, View.OnClickListener {
    ...
    public ARPulsar(ImageTargetActivity activity, SampleApplicationSession session) {
        mActivity = activity;
        ...
        img_view.setOnClickListener(v -> {
            ...
            switch (v.getId()) {
                case R.id.btn_radio_full_middle:
                    ...
                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_radio_w_navi_middle, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "pulsar_radio_navi_middle.png");
                ...
                case R.id.btn_radio_full_left:
                    ...
                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_radio_w_navi_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "pulsar_radio_navi_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_full_right:
                    ...
                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_radio_w_navi_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "pulsar_radio_navi_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;

                case R.id.btn_ac_manual_left:

                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_ac_manual_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "pulsar_ac_manual_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;

                case R.id.btn_ac_manual_right:

                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_ac_manual_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "pulsar_ac_manual_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;

                case R.id.btn_ac_manual_middle:

                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_ac_manual_mid, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "pulsar_ac_manual_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_ac_auto_full_left:
                    ...
                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_ac_auto_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "pulsar_ac_auto_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_ac_auto_full_middle:
                    ...
                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_ac_auto_mid, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "pulsar_ac_auto_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_ac_auto_full_right:
                    ...
                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_ac_auto_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "pulsar_ac_auto_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;

                case R.id.btn_radio_auto_full_middle:

                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_radio_wo_navi_middle, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "pulsar_radio_wo_navi_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;

                case R.id.btn_radio_auto_full_left:

                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_radio_wo_navi_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "pulsar_radio_wo_navi_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;

                case R.id.btn_radio_auto_full_right:

                    mActivity.layoutCameraView.removeAllViews();
                    ImageTargetActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_radio_wo_navi_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "pulsar_radio_wo_navi_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
            ...
            handler.post(() -> {
                ...
                if (userDataToCompare.equalsIgnoreCase("radio_navi_1")
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_radio_w_navi_main, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_radio_navi_main.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));

                    buttonEventInitial(ImageTargetActivity.inflatedLayout.findViewById(R.id.btn_radio_full_middle));
                    buttonEventInitial(ImageTargetActivity.inflatedLayout.findViewById(R.id.btn_radio_full_left));
                    buttonEventInitial(ImageTargetActivity.inflatedLayout.findViewById(R.id.btn_radio_full_right));
                    ...
                    Values.ar_value = Analytics.RADIO_W_NAVI;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_radio_w_navi_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_radio_navi_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.RADIO_W_NAVI;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_radio_w_navi_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_radio_navi_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_ac_manual_full, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_ac_manual_main.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));

                    buttonEventInitial(ImageTargetActivity.inflatedLayout.findViewById(R.id.btn_ac_manual_middle));
                    buttonEventInitial(ImageTargetActivity.inflatedLayout.findViewById(R.id.btn_ac_manual_left));
                    buttonEventInitial(ImageTargetActivity.inflatedLayout.findViewById(R.id.btn_ac_manual_right));
                    ...
                    Values.ar_value = Analytics.MANUAL_AC;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_ac_manual_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_ac_manual_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.MANUAL_AC;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_ac_manual_mid, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_ac_manual_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        || userDataToCompare.equalsIgnoreCase("ac_man_right_5")) {
                    ...
                    Values.ar_value = Analytics.MANUAL_AC;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_ac_manual_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_ac_manual_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_tripreset_switch, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_tripreset_switch.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_ac_auto_full, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_ac_auto_main.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.AUTO_AC;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_ac_auto_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_ac_auto_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.AUTO_AC;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_ac_auto_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_ac_auto_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.AUTO_AC;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_ac_auto_mid, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_ac_auto_middle.png");
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_radio_wo_navi_main, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_radio_wo_navi_main.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));

                    buttonEventInitial(ImageTargetActivity.inflatedLayout.findViewById(R.id.btn_radio_auto_full_middle));
                    buttonEventInitial(ImageTargetActivity.inflatedLayout.findViewById(R.id.btn_radio_auto_full_left));
                    buttonEventInitial(ImageTargetActivity.inflatedLayout.findViewById(R.id.btn_radio_auto_full_right));
                    ...
                    Values.ar_value = Analytics.RADIO_WO_NAVI;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_radio_wo_navi_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_radio_wo_navi_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.RADIO_WO_NAVI;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_radio_wo_navi_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_radio_wo_navi_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    Values.ar_value = Analytics.RADIO_WO_NAVI;
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_radio_wo_navi_middle, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_radio_wo_navi_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_start_stop_ignition, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_start_stop_ignition.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_steering_view_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_steering_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_steering_view_left, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_steering_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));

                } else if (userDataToCompare.equalsIgnoreCase("switch_1")
                        || userDataToCompare.equalsIgnoreCase("switch_4")
                        || userDataToCompare.equalsIgnoreCase("switch_7")) {
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_switch, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_multi_switch.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.pulsar_combimeter, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "pulsar_combimeter.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
