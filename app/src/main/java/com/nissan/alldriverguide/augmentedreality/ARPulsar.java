            ...
            public void onClick(View v) {
                ...
                switch (v.getId()) {
                    case R.id.btn_radio_full_middle:
                        ...
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_radio_w_navi_middle, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "pulsar_radio_navi_middle.png");
                    ...
                    case R.id.btn_radio_full_left:
                        ...
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_radio_w_navi_left, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "pulsar_radio_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_radio_full_right:
                        ...
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_radio_w_navi_right, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "pulsar_radio_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_ac_manual_left:
                        ...
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_ac_manual_left, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "pulsar_ac_manual_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_ac_manual_right:
                        ...
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_ac_manual_right, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "pulsar_ac_manual_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_ac_manual_middle:
                        ...
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_ac_manual_mid, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "pulsar_ac_manual_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_ac_auto_full_left:
                        ...
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_ac_auto_left, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "pulsar_ac_auto_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_ac_auto_full_middle:
                        ...
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_ac_auto_mid, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "pulsar_ac_auto_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_ac_auto_full_right:
                        ...
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_ac_auto_right, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "pulsar_ac_auto_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_radio_auto_full_middle:
                        ...
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_radio_wo_navi_middle, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "pulsar_radio_wo_navi_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_radio_auto_full_left:
                        ...
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_radio_wo_navi_left, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "pulsar_radio_wo_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
                    ...
                    case R.id.btn_radio_auto_full_right:
                        ...
                        mActivity.layoutCameraView.removeAllViews();
                        mActivity.inflatedLayout_second = inflater.inflate(R.layout.pulsar_radio_wo_navi_right, null, false);
                        setBackground(mActivity.inflatedLayout_second, drawables + "pulsar_radio_wo_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout_second);
                        break;
            ...
            handler.post(new Runnable() {
                public void run() {
                    ...
                    if (userDataToCompare.equalsIgnoreCase("radio_navi_1")
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_radio_navi_main.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_radio_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_radio_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_ac_manual_main.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));

                        buttonEventInitial(mActivity.inflatedLayout.findViewById(R.id.btn_ac_manual_middle));
                        buttonEventInitial(mActivity.inflatedLayout.findViewById(R.id.btn_ac_manual_left));
                        buttonEventInitial(mActivity.inflatedLayout.findViewById(R.id.btn_ac_manual_right));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_ac_manual_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_ac_manual_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_ac_manual_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_tripreset_switch.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_ac_auto_main.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_ac_auto_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_ac_auto_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_ac_auto_middle.png");
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_radio_wo_navi_main.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));

                        buttonEventInitial(mActivity.inflatedLayout.findViewById(R.id.btn_radio_auto_full_middle));
                        buttonEventInitial(mActivity.inflatedLayout.findViewById(R.id.btn_radio_auto_full_left));
                        buttonEventInitial(mActivity.inflatedLayout.findViewById(R.id.btn_radio_auto_full_right));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_radio_wo_navi_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_radio_wo_navi_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_radio_wo_navi_middle.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_start_stop_ignition.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_steering_left.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_steering_right.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_multi_switch.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                        ...
                        setBackground(mActivity.inflatedLayout, drawables + "pulsar_combimeter.png");
                        mActivity.layoutCameraView.addView(mActivity.inflatedLayout);
                        mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
