        ...
        img_view.setOnClickListener(v -> {
            ...
            switch (v.getId()) {
                case R.id.btn_ac_manual_full_left:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "xtrail_2017_ac_manual_left.png");
                ...
                case R.id.btn_ac_manual_full_middle:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "xtrail_2017_ac_manual_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_ac_manual_full_right:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "xtrail_2017_ac_manual_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_wo_navi_full_left:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "xtrail_2017_radio_wo_navi_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_wo_navi_full_middle:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "xtrail_2017_radio_wo_navi_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_wo_navi_full_right:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "xtrail_2017_radio_wo_navi_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_full_left:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "xtrail_2017_radio_navi_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_full_middle:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "xtrail_2017_radio_navi_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_radio_full_right:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "xtrail_2017_radio_navi_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_ac_auto_full_left:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "xtrail_2017_ac_auto_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_ac_auto_full_middle:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "xtrail_2017_ac_auto_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
                ...
                case R.id.btn_ac_auto_full_right:
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout_second, drawables + "xtrail_2017_ac_auto_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout_second);
                    break;
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++) {
            ...
            handler.post(() -> {
                ...
                if (userDataToCompare.equalsIgnoreCase("steering_left_1")
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_steering_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_steering_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_tripreset_switch.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_combimeter_view.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_start_stop_ignition.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_multi_switch.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_ac_auto_full.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.xtrail_2017_ac_auto_middle, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_ac_auto_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    ImageTargetActivity.inflatedLayout = inflater.inflate(
                            R.layout.xtrail_2017_ac_auto_right, null, false);
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_ac_auto_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_ac_manual_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_ac_manual_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_ac_manual_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_ac_manual_full.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_radio_wo_navi_full.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_radio_wo_navi_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_radio_wo_navi_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_radio_wo_navi_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_radio_navi_full.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_radio_navi_left.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_radio_navi_right.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_radio_navi_middle.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_parking_brake.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
                    ...
                    setBackground(ImageTargetActivity.inflatedLayout, drawables + "xtrail_2017_all_mode.png");
                    mActivity.layoutCameraView.addView(ImageTargetActivity.inflatedLayout);
                    mActivity.sendMsgToGoogleAnalytics(mActivity.getGoogleAnalyticeName(Values.ar_value));
