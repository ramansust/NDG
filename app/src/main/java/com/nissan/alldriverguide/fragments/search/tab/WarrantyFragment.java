...
public class WarrantyFragment extends Fragment {
    ...
    private void addData() {
        ...
        ArrayList<EpubInfo> list = new PreferenceUtil(requireActivity().getApplicationContext()).retrieveSearchEpubList(Values.carType + Values.UNDERSCORE + new PreferenceUtil(requireActivity().getApplicationContext()).getSelectedLang() + Values.UNDERSCORE + Values.WARRANTY_TYPE);
