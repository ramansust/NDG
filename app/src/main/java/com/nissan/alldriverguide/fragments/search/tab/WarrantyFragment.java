...
public class WarrantyFragment extends Fragment {
    ...
    private void addData() {
        ...
        ArrayList<EpubInfo> list = new PreferenceUtil(Objects.requireNonNull(getActivity()).getApplicationContext()).retrieveSearchEpubList(Values.carType + Values.UNDERSCORE + new PreferenceUtil(getActivity().getApplicationContext()).getSelectedLang() + Values.UNDERSCORE + Values.WARRANTY_TYPE);
